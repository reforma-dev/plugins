...
description: >-
  Distinctive visual identity for new UI or a restyle — palette, type, layout
  that is not a templated default. Use when designing a landing page, picking
  an aesthetic direction, or the UI looks generic.
...
Keep the App Router tree. A visual-identity pass rethemes; it does not replace `app/layout.tsx`.
