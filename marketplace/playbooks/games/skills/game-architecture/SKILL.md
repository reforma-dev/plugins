...
**No title screen by default.** Games boot directly into gameplay. Score HUD is optional. Only add a title/menu scene if the user explicitly requests one.
...
- [ ] **Island mounts** — **PageScreenshot** `/play` is clean
