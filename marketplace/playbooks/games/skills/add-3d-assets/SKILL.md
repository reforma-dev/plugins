...
- Read Constants under `app/play/game/` for entity types, sizes, colors
- Read entity files under `app/play/game/` — find `BoxGeometry`, `SphereGeometry`, etc.
- Read the level/environment module for primitives
...
- Preview this Next app — walk around with WASD, orbit camera with mouse
