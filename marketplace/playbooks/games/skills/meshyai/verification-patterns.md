...
Meshy models typically face +Z, but this varies. After loading, **log the bounding box and visually verify** with **PageScreenshot**:
...
**Always PageScreenshot `/play` after model integration** to visually verify:
