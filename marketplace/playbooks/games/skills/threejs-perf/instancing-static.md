...
Scenario: 140×140 grid = 19,600 cubes, Three.js r183, headless Chromium 147, Apple M1 Pro, 30 warmup + 180 sample frames, median of 3 runs.
...
FPS and frame-time p95 are not cited here — Software WebGL (SwiftShader), which makes GPU-bound timing unreliable. On real hardware the FPS delta would be substantially larger.
