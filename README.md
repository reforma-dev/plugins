...
| shadcn-tailwind  | [shadcn / Tailwind](marketplace/ui/shadcn-tailwind)                      | shadcn      | UI            | Always-on UI foundation. Official primitives + Tailwind. Cannot disable.           |
| context7         | [Context7](marketplace/docs/context7)                                    | Reforma     | Documentation | Up-to-date library docs and code examples. MCP with an API key.                    |
...
Local plugins live under `marketplace/<category>/<name>/`. Origin (first-party vs vendored) is `plugin.json` `author`, not the folder tree. Remote pins stay as GitHub URLs.
