...
| --------------------- | ------------------------------------------------------------------------ | ------------- | ---------- | --------------------------------------------------------------------------------------------------------- |
| bro-mode              | [Bro Mode](marketplace/moods/bro-mode)                                   | Reforma       | Moods      | Talk like your brother — relaxed, blunt, and not afraid to push back                                      |
| zen-mode              | [Zen Mode](marketplace/moods/zen-mode)                                   | Reforma       | Moods      | Calm, minimal replies — no noise, no hype, one clear step at a time                                       |
...
| professor             | [Professor](marketplace/moods/professor)                                 | Reforma       | Moods      | Explain the why — context, tradeoffs, and how the pieces fit together                                     |
| hype-man              | [Hype Man](marketplace/moods/hype-man)                                   | Reforma       | Moods      | Founder energy — big vision, momentum, and belief this thing wins                                         |
...
| react-best-practices  | [React Best Practices](marketplace/ui/react-best-practices)              | Vercel        | UI         | Keep the app fast — React and Next.js performance patterns                                                |
| web-design-guidelines | [Web Design Guidelines](marketplace/ui/web-design-guidelines)            | Vercel        | UI         | Catch accessibility, form, and focus issues before they ship                                              |
| frontend-design       | [Frontend Design](marketplace/ui/frontend-design)                        | Anthropic     | UI         | A look that is not a template — palette, type, and layout with a point of view                            |
...
| n8n                   | [n8n](marketplace/automation/n8n)                                        | n8n           | Automation | Workflows you host yourself — run them and use the results in the app                                     |
